...
func ComputeEventMetrics(db EventStore, eventID string) map[string]string {
	metrics := make(map[string]string)
...
func ComputeAddressMetrics(db EventStore, address string) map[string]string {
	metrics := make(map[string]string)
